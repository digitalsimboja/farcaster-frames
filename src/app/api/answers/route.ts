...
async function getResponse(req: NextRequest): Promise<NextResponse> {
    ...
    if (!correctAnswer) {
        ...
        <title>Error</title>
        <meta property="og:image" content="${config.hostUrl}/images/error.png" />
        <meta property="fc:frame" content="vNext" />
        <meta property="fc:frame:image" content="${config.hostUrl}/images/error.png" />
    ...
    return new NextResponse(`<!DOCTYPE html><html><head>
    <title>Error</title>
    <meta property="og:image" content="${config.hostUrl}/images/answer-${idAsNumber}.png" />
    <meta property="fc:frame" content="vNext" />
    <meta property="fc:frame:image" content="${config.hostUrl}/images/answer-${idAsNumber}.png" />
